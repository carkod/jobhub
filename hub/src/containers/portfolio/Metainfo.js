...
import { Header, List, Dropdown, Segment, Input, Label } from 'semantic-ui-react';
...
const Metainfo = props => {
    ...
    return (
        <div id="metainfo">
            <Header as='h1'>
                <input className="fullwidth__input" type="text" name="name" value={meta.name} onChange={props.name} />
            ...
            <div className="section">
                ...
                <Segment.Group>
                    <Segment.Group horizontal>
                        <Segment>
                            <Input name='projectDate' label="Project date" onChange={props.onChange} value={meta.projectDate} />
                        </Segment>
                        <Segment>
                            <Label>Created</Label>{moment(meta.createdAt).calendar()}</Segment>
                        <Segment><Label>Updated</Label> {moment(meta.updatedAt).calendar()}</Segment>
