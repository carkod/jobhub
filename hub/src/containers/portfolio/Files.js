      ...
      <div className="fileUpload section">
        ...
        <Grid padded celled>
          <Grid.Row columns={2} className="headerRow">
            ...
            <Grid.Column>Number of files</Grid.Column>
          </Grid.Row>
          {this.props.documents &&
            this.props.documents.map((doc, i) => (
              <Grid.Row columns={4} key={doc.fileId}>
                <Grid.Column textAlign="center" width={4}>
                  <button className="btn" onClick={this.deleteDoc(doc)}>
                    <Icon name="delete" className="red large" />
                  </button>
                </Grid.Column>
                <Grid.Column width={4}>
                  <input
                    id="fileName"
                    value={doc.fileName}
                    onChange={this.props.fileNameChange(i)}
                  />
                </Grid.Column>
                <Grid.Column width={4}>
                ...
                <Grid.Column width={16} className="borderTopDashed">
                  <a href={doc.fileURL} title="download">
                    {doc.fileURL}
                  </a>
                </Grid.Column>
              </Grid.Row>
