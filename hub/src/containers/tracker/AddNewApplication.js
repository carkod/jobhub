          ...
          {this.state.contacts.map((contact, i) => (
            <Form.Group key={i}>
              <Form.Input
                ...
                value={this.state.contacts[i].contactName}
              ...
              <Form.Input
                ...
                value={this.state.contacts[i].contactEmail}
                onChange={this.contactInputChange(i)}
              />
              <Form.Input
                width={"6"}
          ...
          {this.state.stages.map((stage, i) => (
            <Form.Group key={i}>
              <Form.Input
                ...
                name="order"
                type="number"
                value={this.state.stages[i].order}
              ...
              <Form.Field width={"1"}>
                ...
                <Checkbox
                  toggle
                  checked={this.state.stages[i].completed}
                  onChange={this.stagesInputChange(i)}
                ></Checkbox>
              </Form.Field>
              ...
              <Form.Input
                ...
                name="action"
                placeholder="Action"
                value={this.state.stages[i].action}
                onChange={this.stagesInputChange(i)}
              />
              <Form.Input
                width={"4"}
                ...
                name="dept"
                placeholder="Type"
                value={this.state.stages[i].dept}
                onChange={this.stagesInputChange(i)}
              />
              <Form.Input
                width={"3"}
          ...
          {this.state.files.map((file, i) => (
            <Form.Group key={i} widths="equal">
              <Form.Input
                ...
                label="File name"
                name="fileName"
                value={this.state.files[i].fileName}
