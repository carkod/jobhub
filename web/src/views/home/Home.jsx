...
class Home extends Component {
  ...
  componentDidMount = async () => {
    try {
      ...
      this.setState(produce((draft) => { draft.cvs = navigationCvs; }));
    } catch (e) {
  ...
  render() {
    ...
    return (
      <div className="ed-home">
        <Metatags title="Professional Profile" description="Software engineer, entrepreneur — building products that scale" />
        ...
        <div className="ed-hero">
          <div className="ed-hero__left">
            ...
            <p className="ed-hero__bio">
              ...
              <a href="https://binbot.in" target="_blank" rel="noreferrer">Binbot</a>,
              a cryptocurrency trading platform. Specialising in React, Node.js,
              and cloud infrastructure — I build products and lead teams.
            </p>
            ...
            <ul className="ed-hero__links">
              ...
              <li>
                <a href="https://github.com/carkod/" target="_blank" rel="noreferrer">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
                  GitHub
                </a>
              </li>
              <li>
                <a href="https://stackoverflow.com/users/2454059/carkod" target="_blank" rel="noreferrer">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="m4 17 1-5"/><path d="M6.5 17h11"/><path d="M6.5 21h11"/><path d="M11 21V6.5"/><path d="m7 11 5-7 5 7"/></svg>
                  Stack Overflow
                </a>
              </li>
              <li>
