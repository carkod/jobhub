  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      const filterProjects = projects.filter(
        (x) => x.cats.locale === "en-GB" && x.cats.status === "public"
      );
        ...
        <div id="primary" className="ui link list">
          <ul>
            ...
            <li className="item dropdown">
              <button className="btn" onClick={this.toggleMenu("cv")}>
                CV
              </button>
              <ul
                id="cv"
                className={
                  this.state.openmenu === "cv" ? "openMenu" : "closeMenu"
                }
              >
            ...
            <li className="item dropdown">
              <button className="btn" onClick={this.toggleMenu("faqs")}>
                FAQs
              </button>
              <ul
                id="faqs"
                className={
                  this.state.openmenu === "faqs" ? "openMenu" : "closeMenu"
                }
              >
                <li className="item">
            ...
            <li className="item dropdown">
              <button className="btn" onClick={this.toggleMenu("portfolio")}>
                Portfolio
              </button>
              <ul
                id="portfolio"
                className={
                  this.state.openmenu === "portfolio" ? "openMenu" : "closeMenu"
                }
              >
                {this.state.projects.map((p) => (
                  <li key={p._id} className="item">
                    <NavLink
                      to={`/portfolio/${p.cats.locale}/${p.cats.position}`}
                      activeClassName="active"
                    >
                      {p.cats.position}
                    </NavLink>
